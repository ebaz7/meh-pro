...
export enum SecurityStatus {
  ...
  APPROVED_SUPERVISOR_CHECK = 'تایید سرپرست / منتظر مدیر',
  PENDING_FACTORY = 'در انتظار تایید مدیر کارخانه',
  APPROVED_FACTORY_CHECK = 'تایید کارخانه / منتظر ارسال',
  PENDING_CEO = 'در انتظار تایید مدیرعامل',
...
export type ShippingDocType = 'Commercial Invoice' | 'Packing List' | 'Bill of Lading' | 'Certificate of Origin' | 'Other';
