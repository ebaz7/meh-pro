...
const Settings: React.FC = () => {
  ...
  // ... (Other handlers omitted for brevity but preserved in final file) ...
  ...
  // Revised Permission Groups for Clarity and Completeness
        ...
        <div className="flex-1 p-6 md:p-8 overflow-y-auto max-h-[calc(100vh-100px)]">
            {activeCategory === 'fiscal' ? (
                ...
                <form onSubmit={handleSave} className="space-y-8 max-w-4xl mx-auto">
                    ...
                    {/* ... (System, Whatsapp, Warehouse, Data, Integration, Template, Commerce sections remain exactly the same as previous) ... */}
                    ...
                    {/* ... (Copy paste other sections logic here from previous response, they are unchanged) ... */}
                    {/* Assuming you want me to keep the file concise, I'm including the FULL Permissions section below which is the key update */}
