...
export interface FiscalYear {
  ...
  isClosed: boolean;
  startTrackingNumber: number; // شماره شروع دستور پرداخت
  startExitPermitNumber: number; // شماره شروع مجوز خروج
  startBijakNumber: number; // شماره شروع بیجک
  createdAt: number;
}
...
export interface PaymentOrder {
  ...
  createdAt: number;
  updatedAt?: number;
  fiscalYearId?: string; // فیلد جدید سال مالی
}
...
export interface SystemSettings { 
    ...
    // فیلدهای جدید سال مالی در تنظیمات
